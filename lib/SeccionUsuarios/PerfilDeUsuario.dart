...
class _EstadisticasUsuarioState extends State<EstadisticasUsuario> {
  ...
  void actualizarDatos() {
    double papelCartonDesdeBD =
        9990; // Obtener desde la base de datos por usuario
    double plasticoMetalVidrioDesdeBD =
        1500000990; // Obtener desde la base de datos por usuario
                      ...
                      if (snapshot.hasData) {
                        ...
                        return CircleAvatar(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize:24, // Reducido el tamaño de fuente para ajustar el número de dígitos
